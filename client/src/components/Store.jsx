           ...
           <div className="">
            ...
            <div className="px-3 pt-3 d-flex align-items-center justify-content-center">
              <p className="lead text-center">
                Patients and Even doctors can upload important health records and doc here,<br/>
                Process is simple af <br/>
                Check out file store form section.<br />
               </p>
            </div>
             </div>
            <hr />
            ...
            <div className="py-3 d-flex align-items-center justify-content-center">
              <h2>Account Address : {this.state.activeAccount}</h2>
            </div>
            {/* File Store Form */}
            ...
            <div className="pb-3">
              <form name="fileStoreForm" onSubmit={this.storeFileToIpfs}>
                ...
                <div className="row mx-5 py-3">
                  <button type="submit" className="btn btn-outline-primary col-6 mx-auto">Store Doc</button>
                </div>
              </form>
            </div>
            ...
            <span className="fs-6">
                ...
                <span className="fs-6 fw-bold"> Transaction Log </span> 
                section will be automatically updated after transaction is being confirmed.</span>
              <br/>
              <br/>
