      ...
      <section id="Ownership" className="p-5">
        ...
        <div className="container">
          <div className="justify-content-between">
            <div>
              <img src="https://img.freepik.com/free-photo/smiling-doctor-with-big-first-aid-kit-cartoon-medical-character_195742-861.jpg?w=360" className="mx-auto d-block" alt="" width="20%" height="20%" />
            </div>
            ...
            <div className="px-3 pt-3 d-flex align-items-center justify-content-center">
              <p className="lead text-center">
                ...
                You can retrive your uploaded documents also.<br />
                <span className="fs-6">
                <span className="fs-6 fw-bold">NOTE:</span> In 
                <span className="fs-6 fw-bold"> Check File Ownership </span> 
